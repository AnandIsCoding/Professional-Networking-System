      ...
      <div className="w-screen h-screen flex flex-col md:flex-row items-center md:fixed">
        ...
        <div className="w-full md:w-1/2 h-1/2 md:h-full px-6 md:px-24 py-4 flex flex-col justify-center gap-4">
          ...
          <button
            ...
            className="flex w-[280px] ml-[7.5vw] md:ml-[9.5vw] items-center cursor-pointer justify-center gap-3 px-6 py-2 bg-white border border-gray-300 rounded-md text-black font-medium text-base hover:bg-blue-50 transition"
          >
            <svg
