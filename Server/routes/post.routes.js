...
import { addPostController, getAllPostController, getAllPostOfUserController, getPostByIdController, getTop5PostsController, likeDislikeController } from '../controllers/post.controller.js'
import upload from '../configs/multer.config.js'

const postRouter = Router()

postRouter.post('/new', isAuthenticated,upload.single('postImage'), addPostController )
